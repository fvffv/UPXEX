...
struct Options final {
    ...
    // UPX Next Generation profiles. These switches describe user intent;
    // individual packers must reject combinations their runtime cannot honor.
    struct {
        bool fast_start;
        bool lz4;
        bool lz4_hc;
        int lz4_acceleration;
        bool lz4_acceleration_set;
        bool misa77;
        int misa77_level;
        bool release_memory;
        bool stub_timing;
